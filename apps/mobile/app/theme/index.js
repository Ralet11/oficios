...
const statusStyles = {
  ...
  OPEN: { backgroundColor: palette.warningSoft, color: palette.warning },
  SELECTION_PENDING_CONFIRMATION: { backgroundColor: palette.accentSoft, color: palette.accentDark },
  MATCHED: { backgroundColor: palette.successSoft, color: palette.success },
  CLOSED: { backgroundColor: palette.infoSoft, color: palette.muted },
  PENDING: { backgroundColor: palette.warningSoft, color: palette.warning },
  AWAITING_PRO_CONFIRMATION: { backgroundColor: palette.accentSoft, color: palette.accentDark },
